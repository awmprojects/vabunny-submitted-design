        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-4">
            <span className="bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent">
              Our VA Matching Process
            </span>
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            From consultation to partnership in 4 simple steps. We make finding your perfect Filipino VA effortless!
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-100 to-indigo-100 rounded-full px-6 py-3 border border-purple-200">
            ...
            <span className="text-purple-800 font-medium">
              Professional VA matching made simple and reliable!
            </span>
          </div>
        </div>
      </div>
