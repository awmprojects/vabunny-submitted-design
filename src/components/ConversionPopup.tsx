        ...
        <div className="space-y-4 sm:space-y-6 py-2 sm:py-4">
          ...
          <div className="space-y-2 sm:space-y-3 text-left">
            <div className="flex items-start gap-2 sm:gap-3">
              ...
              <span className="text-gray-700 text-sm sm:text-base">Expert tips on hiring & managing virtual assistants</span>
            </div>
            <div className="flex items-start gap-2 sm:gap-3">
              <span className="text-green-500 font-bold text-base sm:text-lg">✅</span>
              <span className="text-gray-700 text-sm sm:text-base">Proven strategies to grow your business with less effort</span>
            </div>
            <div className="flex items-start gap-2 sm:gap-3">
              <span className="text-green-500 font-bold text-base sm:text-lg">✅</span>
              <span className="text-gray-700 text-sm sm:text-base">Tools, templates, and insider secrets you won't find anywhere else</span>
            </div>
          </div>
          ...
          <div className="text-center bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4">
            <p className="text-xs sm:text-sm text-gray-700">
              <span className="line-through text-gray-500">Regularly $49/year</span>
